...
my_file_level1_PC = r"Z:\combinedAnalysis\OaklinCopyMNode\code_pipeline\Level1_align-despike-interp\mNode_Port1_20221002_232000_1.csv"
...
#%% For multiple files:
filepath= r"Z:\combinedAnalysis\OaklinCopyMNode\code_pipeline\Level1_align-despike-interp/"
z_filepath = r"Z:\combinedAnalysis\OaklinCopyMNode\code_pipeline\Level4/"
...
eps_combined['epsW_sonic1_MAD'] = np.where(eps_combined['MAD_criteria_met_1']!=True,np.nan,eps_combined['eps_sonic1'])
eps_combined['epsW_sonic2_MAD'] = np.where(eps_combined['MAD_criteria_met_2']!=True,np.nan,eps_combined['eps_sonic2'])
eps_combined['epsW_sonic3_MAD'] = np.where(eps_combined['MAD_criteria_met_3']!=True,np.nan,eps_combined['eps_sonic3'])
eps_combined['epsW_sonic4_MAD'] = np.where(eps_combined['MAD_criteria_met_4']!=True,np.nan,eps_combined['eps_sonic4'])
