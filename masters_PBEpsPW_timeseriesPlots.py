...
ax1.scatter(dates_arr[:break_index+1], prod_df['prod_II'][:break_index+1], s=10, color = 'navy', label = '$P$')
...
ax2.scatter(dates_arr[:break_index+1], prod_df['prod_I'][:break_index+1], s=10, color = 'navy', label = '$P$')
